<div id="edit-blog-form">
    <form novalidate="novalidate" method="post" id="edit_site_9340" enctype="multipart/form-data" class="formtastic form-horizontal site" action="<?php echo isset($Mysite_tpl->id) ? base_url().'My-Sites/edit/'.$Mysite_tpl->id : base_url().'My-Sites/add';?>" accept-charset="UTF-8">
        <div style="margin:0;padding:0;display:inline">
            <input type="hidden" value="<?php echo isset($Mysite_tpl) ? $Mysite_tpl->id :0;?>" readonly="true" name="sites_id" id="sites_id">
            <input type="hidden" value="<?php echo isset($Token_id) ? $Token_id :0;?>" readonly="true" name="token_id" id="token_id">
        </div>
        <div class="row">
            <div class="span9">
                ...
                <fieldset class="inputs">
                    ...
                    <div id="site_signature_input" class="string input optional stringish control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo isset($Mysite_tpl) ? $Mysite_tpl->signature_template : '';?>" placeholder="[USER_ID][TRACKING_ID][REWARD][TIMESTAMP]"  maxlength="255" name="site_signature_template" id="site_signature_template" class="span6">
                    ...
                    <div id="site_digest_method_input" class="radio_buttons input optional control-group">
                        ...
                        <div class="controls">
                            <label for="site_digest_method_plain_digest" class="choice radio">
                                <input class="encryptionMethod" type="radio" value="plain" <?php echo (isset($Mysite_tpl) and $Mysite_tpl->encryption_method=='plain') ? 'checked="checked"' : '';?> name="site_digest_method" id="site_digest_method_plain_digest" checked="checked">Plain</label>
                            <label for="site_digest_method_md5_digest" class="choice radio">
                                <input class="encryptionMethod" type="radio" value="md5" <?php echo (isset($Mysite_tpl) and $Mysite_tpl->encryption_method=='md5') ? 'checked="checked"' : '';?> name="site_digest_method" id="site_digest_method_md5_digest">MD5</label>
                            <label for="site_digest_method_sha1_digest" class="choice radio">
                                <input class="encryptionMethod" type="radio" value="sha1" <?php echo ( isset($Mysite_tpl) and $Mysite_tpl->encryption_method=='sha1') ? 'checked="checked"' : '';?> name="site_digest_method" id="site_digest_method_sha1_digest">SHA1</label>
                            <label for="site_digest_method_hmac_md5_digest" class="choice radio">
                                <input class="encryptionMethod" type="radio" value="hmacmd5" <?php echo (isset($Mysite_tpl) and $Mysite_tpl->encryption_method=='hmacmd5') ? 'checked="checked"' : '';?> name="site_digest_method" id="site_digest_method_hmac_md5_digest">HMAC MD5</label>
                            <label for="site_digest_method_hmac_sha1_digest" class="choice radio">
                                <input class="encryptionMethod" type="radio" value="hmacsha1" <?php echo (isset($Mysite_tpl) and $Mysite_tpl->encryption_method=='hmacsha1') ? 'checked="checked"' : '';?> name="site_digest_method" id="site_digest_method_hmac_sha1_digest">HMAC SHA1</label>
                        </div>
                    </div>
                </fieldset>
            </div>
        ...
        <div class="span9">
            <fieldset class="inputs">
                ...
                <fieldset class="form-actions">
                    <a id="ahrefUploadFyUpload" href="javascript:$('#file_upload').uploadifyUpload();">Added new</a>
                </fieldset>
            </fieldset>
        </div>
    </div>
