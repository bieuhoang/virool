...
(function ($) {
	$.addFlex = function (t, p) {
		...
		var g = {
			...
			buildpager: function () { //rebuild pager based on new properties			
				...
				if (p.usepager) {
					...
					$('.first.paginate_button', g.pDiv).live('click', function (e) {
						e.preventDefault();
						g.changePage('first')
					});
					$('.previous.paginate_button', g.pDiv).live('click', function (e) {
						e.preventDefault();
						g.changePage('prev')
					});
					$('.next.paginate_button', g.pDiv).live('click', function (e) {
						e.preventDefault();
						g.changePage('next')
					});
					$('.last.paginate_button', g.pDiv).live('click', function (e) {
						e.preventDefault();
						g.changePage('last')
					});
					$('.pcontrol a.paginate_button', g.pDiv).live('click', function (e) {
						e.preventDefault();
		...
		t.className = 'dataTable checkAll tDefault';
		$(t).before(g.gDiv);
		$(g.gDiv).append(t);
