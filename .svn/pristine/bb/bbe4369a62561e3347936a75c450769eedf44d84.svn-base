...
<?php echo form_open('ajax/user/add', array('id'=>'form-user-add')) ?>
	...
	<div class="divCls-left">
	    ...
	    <div class="control-group">
		    <label class="control-label" for="inputNewPassword">New password<label class="lable-required">(*)</label></label>
		    <div class="controls">
	...
	<div class="divCls-right">
	    ...
	    <div class="control-group">
		    <label class="control-label" for="inputConfirmNewPassword">Confirm new password<label class="lable-required">(*)</label></label>
		    <div class="controls">
		    	<input type="password" id="inputConfirmPassword" name="inputConfirmPassword" class="input-xlarge" placeholder="Password" >
		    </div>
	    </div>
	    <div class="control-group">
